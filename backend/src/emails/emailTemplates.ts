...
export const createConnectionAcceptedEmailTemplate = (senderName: string, recipientName: string, profileUrl: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
export const createCommentNotificationEmailTemplate = (recipientName: string, commenterName: string, postUrl: string, commentContent: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
